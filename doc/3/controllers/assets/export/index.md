...
```http
POST: http://kuzzle:7512/_/device-manager/:index/assets/_export
Body: {
...
```http
GET: http://kuzzle:7512/_/device-manager/:index/assets/_export/:exportId
```
...
```js
{
  ...
  "result": {
    "link": "/_/device-manager/<index>/assets/_export/<exportId>"
  }
}
```
