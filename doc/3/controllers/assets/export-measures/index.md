...
```http
POST: http://kuzzle:7512/_/device-manager/:index/assets/:_id/measures/_export
GET:  http://kuzzle:7512/_/device-manager/:index/assets/:_id/measures/_export/:exportId
```
