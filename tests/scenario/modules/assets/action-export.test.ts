...
describe("AssetsController:exportMeasures", () => {
  ...
  it("should prepare export of different assets types and return a CSV as stream", async () => {
    ...
    expect(csv[0]).toBe(
      "Model,Reference,magiculeExt,magiculeInt,position,position.accuracy,position.altitude,temperatureExt,temperatureInt,temperatureWeather,lastMeasuredAt,lastMeasuredAtISO\n",
    );
