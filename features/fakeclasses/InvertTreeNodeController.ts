    ...
    this.definition = {
      actions: {
        create: {
          ...
          http: [
            { path: "device-manager/:engineId/invertTreeNode", verb: "post" },
          ],
        },
        delete: {
          ...
          http: [
            {
              path: "device-manager/:engineId/invertTreeNode/:_id",
              verb: "delete",
            },
          ],
        },
        link: {
          ...
          http: [
            {
              path: "device-manager/:engineId/invertTreeNode/:_id/children/:_childrenId",
              verb: "put",
            },
          ],
        },
