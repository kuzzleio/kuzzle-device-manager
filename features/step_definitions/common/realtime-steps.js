...
Then(
  "I should have {string} subscriber on {string}:{string} with filter:",
  async function (rawCount, index, collection, rawFilter) {
...
Then(
  "I should have {string} subscriber on {string}:{string} without filter",
  async function (rawCount, index, collection) {
    const expectedCount = parseInt(rawCount, 10);
