Feature: multipleLink
  ...
  Scenario: Link two devices to an asset
    When I successfully execute the action "device-manager/device":"mLinkAssets" with args:
      ...
      | body.linkRequests[0].deviceLink.measureNamesLinks[0].deviceMeasureName | "outerTemp"    |
      ...
      | body.linkRequests[1].deviceLink.measureNamesLinks[0].deviceMeasureName | "outerTemp"    |
