Feature: Device Manager Decoders
  ...
  Scenario: List all registered decoders
    ...
    Then I should receive a result matching:
      | decoders | [{"deviceModel":"DummyTemp","deviceMeasures":["temperature"]},{"deviceModel":"DummyTempMultipleDevice","deviceMeasures":["innerTemp","extTemp","batteryLevel"]},{"deviceModel":"DummyTempPosition","deviceMeasures":["temperature","position"]}] |
