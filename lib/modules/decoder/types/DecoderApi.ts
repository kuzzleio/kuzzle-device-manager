...
export interface ApiDecoderPrunePayloadsRequest extends DecoderControllerRequest {
  action: 'prunePayloads';

  _id: string;
}
export type ApiDecoderPrunePayloadsResult = ReturnType<DecoderController["prunePayloads"]>;
